 ...
 * @author cqnews
 */
public class WeApiWorkContext extends BaseWorkContext {
    ...
    public WeApiWorkContext() {
    }

    public WeApiWorkContext(String apiKey, String apiSecret, String accessToken, String token, String openId, String sessionId) {
        this.apiKey = apiKey;
