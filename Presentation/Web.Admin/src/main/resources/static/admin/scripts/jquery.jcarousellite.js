...
(function($) {                                          // Compliant with jquery.noConflict()
    ...
    $.fn.jCarouselLite = function(options) {
        ...
        return this.each(function() {   // Returns the element collection. Chainable.
            ...
            var running,
                animCss, sizeCss,
                div = $(this), ul, initialLi, li, liimg,
            ...
            function initVariables() {
                ...
                ul = div.find(">" + options.ul);
                initialLi = ul.find(">" + options.li);
            ...
            function initSizes() {
                ...
                li.css({
                    width: li.width(),
                    height: options.height > 0 ? li.width() / options.height : li.height()
                });
                ...
                if(options.btnGo) {
                    $.each(options.btnGo, function(i, val) {
                        $(val).click(function() {
                            ...
                            return go(options.circular ? numVisible * (i+1) : i);
                        });
                    });
                }
            ...
            function highlightGoButtons() {
                if(options.btnGo) {         // If GO buttons have been provided, only then get into highlighting mode
                    ...
                    if(options.circular) {  // If Circular, then we have some calculations to make, none otherwise
						...
						$(options.btnGo[buttonIndex/options.scroll]).addClass(options.highlightClass);
    ...
    $.fn.jCarouselLite.options = {
        ...
        highlightClass: "hover",    // Class for highlighting GO buttons when the corresponding item is displayed
