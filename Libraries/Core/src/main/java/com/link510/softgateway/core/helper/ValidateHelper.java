...
public class ValidateHelper {
     ...
     */
    public final static String englishOrChineseRegex = "^[A-Za-z]*|[\u4E00-\u9FA5]*$";
    ...
    public static boolean isValidEnglishOrChinese(String str) {
        ...
        // 2、[\u4E00-\u9FA5]* 汉字匹配 一次或者多次
        boolean flag = false;
        Pattern p = Pattern.compile(englishOrChineseRegex);
        if (str != null) {
     ...
     */
    public final static String nameRegex = "^[A-Za-z]*|[\u4E00-\u9FA5]*$";
     ...
     * 18位身份证号码
     */
    public static final String idCardRegex = "^\\d{17}(\\d{1}|x)$";


    /***************************************************************************
     * 18位身份证号码
     */
    public static final String shortIdCardRegex = "^\\d{15}$";

    /**
     * 验证所有的身份证号码
     */
    public static final String idCardAllRegex = "^\\d{15}|^\\d{17}(\\d{1}|x)$";
    ...
    public static boolean isValidIdCard(String cardStr) {
        boolean flag = false;
        Pattern pEighteen = Pattern.compile(idCardRegex);// 18位身份证号码
        // 包括末尾是“x”的校验码
        Pattern pFifteen = Pattern.compile(shortIdCardRegex);// 15位身份证号码
        if (cardStr != null) {
     ...
     * 整数验证(包括正整数与 负整数)
     */
    public static final String noRegex = "^-?\\d*$";
    ...
    public static boolean isValidNo(String str) {
        boolean flag = false;
        Pattern p = Pattern.compile(noRegex);
        if (str != null) {
            Matcher match = p.matcher(str);
            flag = match.matches();
        }
     ...
     * 整数验证(包括正整数与 负整数)
     */
    public static final String nonNegativeRegex = "^\\d+$";
    ...
    public static boolean isValidNonNegative(String str) {
        boolean flag = false;
        Pattern p = Pattern.compile(nonNegativeRegex);
        if (str != null) {
            Matcher match = p.matcher(str);
            flag = match.matches();
        }
    ...
    public static boolean isValidPositiveint(String str) {
        boolean flag = false;
        Pattern p = Pattern.compile(PositiveintRegex);
        if (str != null) {
            Matcher match = p.matcher(str);
            flag = match.matches();
     ...
     * 匹配英文字母(汉语拼音)
     */
    private final static String englishRegex = "^[A-Za-z]*$";
    ...
    public static boolean isValidEnglish(String str) {
        boolean flag = false;
        Pattern p = Pattern.compile(englishRegex);
        if (str != null) {
            Matcher match = p.matcher(str);
            flag = match.matches();
        }
     ...
     * 匹配英文字母(汉语拼音)
     */
    private final static String nonSpecialCharRegex = "^[A-Za-z\u4E00-\u9FA5\\d]*$";
    ...
    public static boolean isValidNonSpecialChar(String str) {
        boolean flag = false;
        Pattern p = Pattern.compile(nonSpecialCharRegex);
        if (str != null) {
            Matcher match = p.matcher(str);
            flag = match.matches();
        }
     ...
     */
    public final static String telephoeNoRegex = "^\\d{3,4}\\d{7,8}(\\d{3,4})?$";
    ...
    public static boolean isValidTelephoeNo(String telephoeNo) {
        boolean flag = false;
        Pattern p = Pattern.compile(telephoeNoRegex);
     ...
     * 2、\\d{8} 整数出现8次
     */
    public final static String mobileRegex = "^((13[0-9])|(14[57])|(15[012356789])|(17[3678])|(18[0123456789]))\\d{8}$";
     ...
     * {1,3}表示可以出现一次或两次或者三次.
     */
    public final static String emailRegex = "\\w+@(\\w+\\.){1,3}\\w+";
    ...
    public final static String hourRegex = "^[0-2][0-9]$";
     ...
     */
    public final static String dayStrRegex = "^\\d{2}\\d{2}\\d{2}$";
    ...
    public static boolean isValidDay(String dayStr) {
        ...
        Matcher match = p.matcher(dayStrRegex);
        if (dayStr != null) {
     ...
     *
     */
    public final static String dateRegex = "^\\d{4}\\d{2}\\d{2}$";
    ...
    public final static String userNameRegex = "^[a-zA-Z][a-zA-Z0-9]{5,19}$";
    ...
    public final static String accountRegex = userNameRegex + "|" + mobileRegex + "|" + emailRegex;
    ...
    public final static String ipRegex = "(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)";
     ...
     * 验证网址Url
     */
    public final static String urlRegex = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?";
     ...
     * 验证输入密码条件(字符与数据同时出现)
     */
    public final static String passwordRegex = "[A-Za-z]+[0-9]{6,18}";
     ...
     * 验证输入密码长度 (6-18位)
     */
    public final static String passwordLenthRegex = "^\\d{6,18}$";
    ...
    public static boolean isPasswordLength(String password) {
        ...
        return match(passwordLenthRegex, password);
    }
     ...
     * 验证输入密码长度 (6-18位)
     */
    public final static String decimalRegex = "^[0-9]+(.[0-9]{2})?$";
    ...
    public static boolean isDecimal(String str) {
        return match(decimalRegex, str);
    }

    /****************************************************************************
     * 验证大写字母
     */
    public final static String upCharRegex = "^[A-Z]+$";
     ...
     * 验证小写字母
     */
    public final static String lowCharRegex = "^[a-z]+$";
